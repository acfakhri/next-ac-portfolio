  ...
  return (
    ...
    <div className='space-y-6'>
      ...
      <p className='font-light text-md leading-7'>
        ...
        keen ability to master various web frameworks. My journey began with a solid foundation in HTML, CSS, and JavaScript, enabling 
      ...
      <p className='font-light text-md leading-7'>
        ...
        experience, he actively seeks resources and tutorials to stay up-to-date with web developss evolving landscape. Reza dedication
        and versatility mark him as a valuable addition to any web development team, and his journey has just begun. He on the path to
